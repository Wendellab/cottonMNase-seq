...
######################## 08-31-2020 ########################################
## quantile normalize by subgenome
system("cat mappingF2020/FcD_q20_chr.size_w20_qnorm.bg|grep ^A |sed 's/^A/Chr/g' >mappingF2020/FcDa_q20_chr.size_w20_qnorm.bg")
system("cat mappingF2020/FcD_q20_chr.size_w20_qnorm.bg|grep ^D |sed 's/^D/Chr/g' >mappingF2020/FcDd_q20_chr.size_w20_qnorm.bg")
system("cat mappingM_UTX/McD_q20_chr.size_w20_qnorm.bg|grep ^A |sed 's/^A/Chr/g' >mappingM_UTX/McDa_q20_chr.size_w20_qnorm.bg")
system("cat mappingM_UTX/McD_q20_chr.size_w20_qnorm.bg|grep ^D |sed 's/^D/Chr/g' >mappingM_UTX/McDd_q20_chr.size_w20_qnorm.bg")
