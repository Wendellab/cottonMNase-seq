...
## Conserved Noncoding Sequence (CNSs)

The COGE CNS Discovery Pipeline was used to find CNSs between A2 vs D5, At vs Dt, A2 vs At, D5 vs Dt genomes.The resulting common CNSs were used to inquiry whether or not chromatin accessible regions are conversed across genomes. [cns.sh](scripts/cns.sh)
